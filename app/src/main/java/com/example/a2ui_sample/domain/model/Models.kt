...
data class TableBooking(
    ...
    companion object {
        fun generateBookingId(): String {
            ...
            return "TB-${format.format(Date())}"
        }
    }
}

enum class OrderStatus { PREPARING, COMPLETED }

data class OrderItem(val menuItem: MenuItem, val quantity: Int)
