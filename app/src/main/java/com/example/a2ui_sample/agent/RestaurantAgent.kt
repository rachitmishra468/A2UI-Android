...
class RestaurantAgent(private val repository: MenuRepository) {
    ...
    private val adkAgent = LlmAgent(
        ...
        instruction = Instruction(
           ...
           Examples (follow these EXACTLY):
             ...
             User: add masala dosh to my cart   (typo)
             Tool: add_item_to_cart(itemName="Masala Dosa")

             User: put paneer burger in my cart
             Tool: add_item_to_cart(itemName="Paneer Burger")
             ...
             Tool: search_menu(category="vegetarian")
    ...
    suspend fun processQuery(query: String): List<String> {
        ...
        // Reset tools state before starting new reasoning
